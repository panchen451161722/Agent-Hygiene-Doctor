...
describe("OperationStore", () => {
  it("lists only safe public operation fields", async () => {
    ...
    const operation: RemovalOperation = {
      schemaVersion: OPERATION_SCHEMA_VERSION, operationId: "123e4567-e89b-42d3-a456-426614174000", toolVersion: "1.1.0", createdAt: "2026-07-13T00:00:00.000Z", status: "planned",
